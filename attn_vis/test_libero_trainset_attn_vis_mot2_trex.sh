...

{
  for key in \
    ...
    DATA_JSON ACTION_MODEL_PATH QWEN3VL2B_MODEL_PATH COSMOS_MODEL_PATH COSMOS_EXPERIMENT_NAME COSMOS_TEXT_CACHE_PATH \
    ACTION_DIM ACTION_CHUNK VIDEO_H VIDEO_W VIDEO_FRAMES NUM_COND_INPUT_FRAMES \
    ROBOT_STATE STATE_PLACEHOLDER_TOKENS STATE_DIM STATE_ENCODING_MODE \
    BRIDGE_POS_SCHEME RIGHT_SINGLE_ATTN_POSITION \
...
echo "[INFO] right single-attn position: ${RIGHT_SINGLE_ATTN_POSITION}"
