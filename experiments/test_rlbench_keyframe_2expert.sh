...
RUN_NAME="${RUN_NAME:-cosmos2B_janus1B_2expert_rlbench_keyframe_tokenlatent_2latent}"
...
TOTAL_LATENT_TOKENS="${TOTAL_LATENT_TOKENS:-2}"
...
SAVE_COSMOS_VIDEOS="${SAVE_COSMOS_VIDEOS:-true}"
...
python -u "$LAST05_ROOT/experiments/robot/rlbench/run_rlbench_eval_keyframe.py" \
  --pretrained_checkpoint "$PRETRAINED_CHECKPOINT" \
