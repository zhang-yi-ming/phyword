...

{
  for key in LAST05_ROOT EXPERIMENTS_ROOT OUTPUT_ROOT_DIR RUN_NAME RUN_DIR CHECKPOINT_NAME PRETRAINED_CHECKPOINT \
    EVAL_ARTIFACT_NAME RESULT_DIR JANUS_MODEL_PATH ACTION_MODEL_PATH QWEN3VL2B_MODEL_PATH COSMOS_MODEL_PATH COSMOS_EXPERIMENT_NAME COSMOS_TEXT_CACHE_PATH \
    ...
    TOTAL_LATENT_TOKENS SPECIAL_TOKEN_VOCAB IMG_LATENTS_PER_FUTURE STATE_LATENTS_PER_FUTURE NUM_FUTURE_FRAMES FUTURE_FRAME_STRIDE \
    ROBOT_STATE STATE_PLACEHOLDER_TOKENS STATE_DIM STATE_ENCODING_MODE \
    BRIDGE_POS_SCHEME RIGHT_SINGLE_ATTN_POSITION ACTION_DENOISE_STEPS COSMOS_DENOISE_STEPS \
