...
EXPERIMENT_NAME="cosmos_janus_3expert_libero_spatial_new_debug"

RUN_NAME="cosmos2B_janus1B_2expert_spatial_token_no_tr"

OUTPUT_ROOT_DIR="../exp_cosmos_vla_3expert"

DATA_JSON="/mnt/nas/zhangyiming/database/data/libero_training_data_last05_lastest/libero_spatial_20hz_224_dual/train_with_atomic_action.json"
