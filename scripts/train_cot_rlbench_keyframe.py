"""
Training script for RLBench keyframe 3-Expert MoT with beta token-latent CoT.
...
Key differences from train.py (2-expert):
  ...
  - Reads v/n/vn token-latent labels from the RLBench keyframe JSON
  - Forward returns 4 losses: total, video, action, latent CE

Usage:
  accelerate launch ... train_cot_rlbench_keyframe.py \
...
class VLACotDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        action_frame_pil = first_frame_pil
        ...
        if (
            ...
            item["value"] = self._compute_value_target(sample)
        return item
