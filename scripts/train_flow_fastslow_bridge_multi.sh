...
export MASTER_ADDR=10.20.16.118
...
MANUAL_S1_CKPT="/media/liuzhuoyang/LCoT_VLA_MOT/exp/latent_cot_mot_flow/janus_pro_siglip_uni3d_1B_1e-4_mot_pretrain1220e1_bridgev2_view1_sparse_slow1_fast4_state_8_0101/stage1/checkpoint-3-130172/tfmr"

DATA_JSON="/media/liuzhuoyang/LCoT_VLA_MOT/training_data/bridge_single_json/bridgev2_view1_chunk4_fast4_dense_fastslow_train.json"
...
BASE_RUN_NAME="janus_pro_siglip_uni3d_1B_1e-4_mot_pretrain1220e5_bridgev2_view1_dense_slow1_fast4_state_8_0116"
...
if [ -z "$MANUAL_S1_CKPT" ]; then
    echo "Error: MANUAL_S1_CKPT is not defined. Cannot start Stage 2."
    exit 1
fi

echo "=========================================================="
echo "Starting Stage 2 Training (Multi-Node Action Expert Only)"
echo "Input Model: ${MANUAL_S1_CKPT}"
echo "Target Dir : ${OUTPUT_ROOT_DIR}/${EXPERIMENT_NAME}/${STAGE2_SUB_NAME}"
echo "=========================================================="
...
echo "=========================================================="
echo "Stage 2 Multi-Node Training Finished!"
echo "=========================================================="