...
BASE_RUN_NAME="janus_pro_siglip_uni3d_1B_1e-4_mot_pretrain1220e5_tienkung_pick_button_dex_2stage_view1+1_primary_sparse_slow1_fast4_state_8_0126"
EXPERIMENT_NAME="latent_cot_mot_flow_tienkung"
OUTPUT_ROOT_DIR="../exp"

DATA_JSON="/media/liuzhuoyang/LCoT_VLA_MOT/training_data/tienkung_dual_json/pick_button_dex_view1+1_chunk4_fast4_sparse_fastslow_train.json"
ORIGIN_MODEL_PATH="/media/liuzhuoyang/LCoT_VLA/Janus-Pro-1B"
ACTION_MODEL_PATH="/media/liuzhuoyang/LCoT_VLA/exp_pretrain/action_only_flow/janus_pro_siglip_encoder_1B_no_state_lr_2e-5_flow_1217/checkpoint-0-1106069/tfmr"
...
if [ -z "$MANUAL_S1_CKPT" ]; then
    ...
    accelerate launch --config_file ../config/sft.yaml \
        ...
        --num_machines 1 \
        --machine_rank 0 \
        --deepspeed_multinode_launcher standard train_janus_siglip_flow_fastslow_wopc.py \
