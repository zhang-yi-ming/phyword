...
DATA_JSON="${DATA_JSON:-/mnt/amlfs-07/shared/physicalword/rlbench/train/json/train_action_chunk1_sumpos_lastrot_shared.json}"
...
echo ">>> Starting FiS 2-MoT RLBench keyframe training: ${RUN_NAME}"
