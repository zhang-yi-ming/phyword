            ...
            for file in os.listdir(f'{data_root}/{task}'):
                ...
                for i in range(episode_length):
                    ...
                    episode_data = {
                        ...
                        'language_instruction': 'grab the test tubes from the left workbench and place them in the test tube rack on the right workbench',
                    }
...
def cal_stats(jsonl_filename):
    ...
    action_mask = [True, True, True, True, True, True, False, True, True, True, True, True, True, False, False, False, False, False, False, False]
    state_mask = [True, True, True, True, True, True, False, True, True, True, True, True, True, False, False, False, False, False, False, False]
...
data_root = "/media/liuzhuoyang/data/robomindv2/agilex_mobile/npy_key"
img_save_root = "/media/liuzhuoyang/LCoT_VLA_MOT/training_data/agilex_mobile_sparse_fastslow"
json_save_root = "/media/liuzhuoyang/LCoT_VLA_MOT/training_data/agilex_mobile_json"

jsonl_filename = f'{json_save_root}/insert_tube_view1+3_chunk4_fast4_sparse_fastslow_train.jsonl'
json_file = f'{json_save_root}/insert_tube_view1+3_chunk4_fast4_sparse_fastslow_train.json'
