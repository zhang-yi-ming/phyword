...
IMAGE_VIEWS_SAVE = ['image_third', 'image_wrist'] 
IMAGE_VIEWS_SLOW = ['image_third'] 
IMAGE_VIEWS_FAST = ['image_third', 'image_wrist'] 
FUTURE_STEPS = 4
FAST_SLOW_RATIO = 4
...
data_root = "/media/liuzhuoyang/data/franka/npy"
img_save_root = "/media/liuzhuoyang/LCoT_VLA_MOT/training_data/franka_single_sparse_fastslow"
json_save_root = "/media/liuzhuoyang/LCoT_VLA_MOT/training_data/franka_single_json"

jsonl_filename = f'{json_save_root}/press_stamp_view1+2_chunk4_fast4_sparse_fastslow_train.jsonl'
json_file = f'{json_save_root}/press_stamp_view1+2_chunk4_fast4_sparse_fastslow_train.json'

task_lists = [
#   'put_egg_on_bread_0829_keyframe',
#   'put_dish_at_rack_0827_keyframe',
  'press_stamp_0827_keyframe',
    # 'wipe_whiteboard_0824_keyframe'
]
