        ...
        for task in task_lists:
            ...
            for file in os.listdir(f'{data_root}/{task}'):
                ...
                for i in range(episode_length):
                    ...
                    image_old_list = []
                    for view in IMAGE_VIEWS:
                        image_old_list.append(f'{save_dir}/image{i}_{view}.png') 
...
def cal_stats(jsonl_filename):
    ...
    with open(jsonl_filename, 'r') as f:
        for line in f:
            ...
            match = re.search(r'episode(\d+)', data['input_images'][0])
            if match:
...
img_save_root = "/media/liuzhuoyang/LCoT_VLA_MOT/training_data/rlbench_1view"
json_save_root = "/media/liuzhuoyang/LCoT_VLA_MOT/training_data/rlbench_json"
jsonl_filename = f'{json_save_root}/12tasks_1view_chunk4_img+pc+state_train.jsonl'
json_file = f'{json_save_root}/12tasks_1view_chunk4_img+pc+state_train.json'
